...
use backend\models\CountryySearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * CountryyController implements the CRUD actions for Countryy model.
 */
class CountryyController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all Countryy models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new CountryySearch();
    ...
    {
        if (($model = Countryy::findOne($id)) !== null) {
            return $model;
        }
