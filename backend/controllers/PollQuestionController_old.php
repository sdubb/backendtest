...
class PollQuestionController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if($model->validate()){
                ...
                if($model->save()){
                    Yii::$app->session->setFlash('success', "Poll Question created successfully");
    ...
    public function actionUpdate($id)
    {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            if($model->save(false)){
                Yii::$app->session->setFlash('success', "Poll Question updated successfully");
                return $this->redirect(['index']);
            }
    ...
    public function actionDelete($id)
    {
        ...
        $userModel->status =  PollQuestion::STATUS_DELETED;
