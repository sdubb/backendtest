...
<?= Html::a('Tickets', ['/event-ticket', 'EventTicketSearch[event_id]' => $model->id], ['class' => 'btn btn-success']) ?>    
    <?= Html::a('View Booked Tickets', ['/event-ticket-booking', 'EventTicketBookingSearch[event_id]' => $model->id], ['class' => 'btn btn-success']) ?>
    ...
    echo DetailView::widget([
        ...
        'attributes' => [
            ...
            'updated_at:datetime',
            [
                'attribute'  => 'organisor_id',
                'value' => function($model){
                    return @$model->eventOrganisor->name;
                },
                'format'=>'raw'
