        ...
        <div  class="row" style="padding:10px;">
            <?php 
                ...
                ?>
                    ...
                    <div class="col-sm-3">
                    <?php  echo $form->field($model, 'feature[]')->checkBox(['label' => $record['name'],'checked'=>($record['is_active'])?true:false, 'data-size'=>'small', 'style'=>'margin-bottom:4px;','value'=> $record['id']]);?>
