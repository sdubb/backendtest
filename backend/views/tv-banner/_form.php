...
<div class="countryy-form">
    ...
    <?php $model->tvbannerhiddenurl = Yii::$app->urlManager->createUrl(['tv-banner/banner-reference', 'reference_id'=>$model->reference_id ,'id'=>'']); ?>
    <?= $form->field($model, 'tvbannerhiddenurl')->hiddenInput()->label(false); ?>
...
function bannerType(){
    var id = $('#tvbanner-banner_type').val();
    var url = $("#tvbanner-tvbannerhiddenurl").val();
    var fullurl = url+id;
