...
$this->title = 'Tv Show details :'.$model->name;
    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <div class="pull-center"><?= Html::a('Create Episode', ['tv-show-episode/create', 'tv_show_id' => $model->id], ['class' => 'btn btn-success pull-right']) ?></div>   
            ...
            <div class="box-body">
                ...
                'attributes' => [           
                    ...
                    [
                        'attribute'  => 'tv_channel_id',
                        'value' => function($model){
                            return @$model->tvChannel->name;
