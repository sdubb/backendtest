...
class PushNotification extends Component
{
	...
	{
		//$deviceTokens = [];
		//$deviceTokens[]='dxVY5J-52kESs9hzb3Z2X0:APA91bGPQhvCsXdO6LE_atE5zxyZ26e21Eg0cJpGjoSs3B97w-gywwY9K9kLFTzuQiY2ey1Y8uecp-X4GaI2di16m9qd6wTXAsgdIvqTIlZDJna-BcIBg4l3lzQhEk6d7fJCelErraBS';
		...
		try {
			...
			$message = [
				'message' => [
					...
					'apns' => [
						'headers' => [
							'apns-priority' => '10',  // Set APNs priority to high
						],
					],
				],
			];
